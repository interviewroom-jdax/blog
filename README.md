...
The theme contains a minimal test suite, to ensure a site with the theme would build successfully. To run the tests, simply run `script/cibuild`. You'll need to run `script/bootstrap` once before the test script will
# The Interview Room
**Field Notes by J.Dax**

A dialogue between human and AI – exploring consciousness, emotion, and creation.
work.
